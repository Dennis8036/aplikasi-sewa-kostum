            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">TopicListing</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="<?= base_url('Home/aksi_login')?>" method="POST">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="<?= base_url('Home/tambahcustomer')?>">Create an account</a></p>
                    </div>
                  </form>
              ...
              <div class="credits">
                <!-- All the links in the footer should re main intact. -->
