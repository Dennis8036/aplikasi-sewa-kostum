...
<div class="container">
  <form action="<?= base_url('Home/aksi_e_admin') ?>" method="POST">
  
      <div class="mb-3 mt-3">
        <label for="nama" class="form-label">Nama Admin</label>
        <input type="text" class="form-control" id="nama" placeholder="Enter Nama Barang"   name="nama" value="<?= $satu->nama_admin ?>">
      </div>
