...
<div class="container">
  <form action="<?= base_url('Home/aksi_e_customer') ?>" method="POST">
  
      <div class="mb-3 mt-3">
        <label for="nama" class="form-label">Nama Customer</label>
        <input type="text" class="form-control" id="nama" placeholder="Enter Nama Barang"   name="nama" value="<?= $satu->nama_customer ?>">
      </div>
 ...
 <div class="mb-3 mt-3">
      ...
      <input type="hidden" name="id" value="<?= $satu->id_customer ?>">
